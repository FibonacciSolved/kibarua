...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li><a href=""  class="citySearch" data-target="Nakuru"><i class="fa fa-circle-o text-yellow"></i> Nakuru</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2016-2017 <a href="#e">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
