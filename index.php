...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Kibarua</b> Job Portal</span>
    </a>
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center index-head">
            ...
            <p>A Freelancer is One search away</p>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              ...
              <div class="caption">
                <h3 class="text-center">Apply & Get that Kibarua</h3>
              </div>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              ...
              <div class="caption">
                <h3 class="text-center">Start A Career freelancing</h3>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="company" class="content-header">
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Companies and Employers</h1>
            <p>Hiring? Register your company for free, browse our talented pool, post and track job applications. You will surely find a reliable freelancer</p>            
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p>Registered Companies and Employers</p>
            </div>
            <div class="icon">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2016-2017 <a href="#">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
